                  ...
                  <div>
                    ...
                    {selectedTeam.role === 'admin' && (
                      <div className="mt-2 flex items-center">
                        ...
                        <code className="ml-2 px-2 py-1 bg-gray-800/50 rounded text-xs font-mono text-gray-300">{selectedTeam.id}</code>
                        <button 
                          onClick={() => {
                            navigator.clipboard.writeText(selectedTeam.id);
                            setError("Team ID copied to clipboard!");
                            setTimeout(() => setError(null), 3000);
                          }}
                          className="ml-2 p-1 text-gray-400 hover:text-white transition-colors rounded-md hover:bg-white/10"
                          title="Copy Team ID"
                        >
